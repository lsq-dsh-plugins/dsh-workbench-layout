...
- Color file-tree entries and middle-editor tabs from Workspace Git state: untracked, deleted, or conflicted files are red; added files are green; modified files are blue; renamed files use the warning color. Directories inherit the highest-priority descendant state.
...
- Stage, unstage, discard, and commit through explicit actions.
