...
- Stage, unstage, discard, and commit through explicit actions. Native-style bare per-file icons overlay the path on hover without permanently reducing the filename width.
