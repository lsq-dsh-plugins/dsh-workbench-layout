...
- `src/client/editor-track-transition.ts`: temporary editor/conversation track coordination using AppFrame's official timing and easing, released at the matching endpoint.
