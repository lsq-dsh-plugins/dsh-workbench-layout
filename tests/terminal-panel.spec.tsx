...
describe('终端左栏', () => {
  it('管理当前工作区的多个终端并显示运行状态', () => {
    current.state = {
      sidebarMode: 'terminal', workspaceId: 'workspace-1', activeTabId: 'terminal:1', diffViewMode: 'split',
      tabs: [
  ...
  it('首次进入空终端视图时创建一个终端，但关闭最后一个后不循环重建', () => {
    current.state = {
      sidebarMode: 'terminal', workspaceId: 'workspace-1', diffViewMode: 'split', tabs: [],
    }
